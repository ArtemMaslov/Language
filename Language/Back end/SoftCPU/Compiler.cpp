...
static ProgramStatus CompileFunctDef(Compiler* comp, const FunctDefNode* functNode);

static ProgramStatus CompileFunctCall(Compiler* comp, const FunctCallNode* functCallNode);

static ProgramStatus CompileInstrinsicFunction(Compiler* comp, FunctCallNode* functCallNode);

static ProgramStatus CompileWhile(Compiler* comp, const WhileNode* whileNode);

static ProgramStatus CompileIf(Compiler* comp, const IfNode* ifNode);

static ProgramStatus CompileOutput(Compiler* comp, const OutputNode* outputNode);

static ProgramStatus CompileInput(Compiler* comp, const InputNode* inputNode);

static ProgramStatus CompileExpression(Compiler* comp, const ExpressionNode* exprNode);

static ProgramStatus CompileUnaryOperator(Compiler* comp, const UnaryOperatorNode* unOperNode);

static ProgramStatus CompileBinaryOperator(Compiler* comp, const BinaryOperatorNode* binOperNode);

static int IdentifierGetMemoryOffset(Compiler* comp, const int varId, bool* outVarInitialization = nullptr);

static ProgramStatus CompileReturn(Compiler* comp, const ReturnNode* returnNode);

static ProgramStatus CompileNumber(Compiler* comp, double number);

static ProgramStatus CompileVariable(Compiler* comp, const VariableNode* varNode);

static ProgramStatus CompileInstrBlock(Compiler* comp, const ExtArray* instrBlock);

static ProgramStatus CompileConstrNodes(Compiler* comp);

static ProgramStatus CompileCompareOperator(Compiler* comp, const BinaryOperatorNode* binOperNode);
...
static int IdentifierGetMemoryOffset(Compiler* comp, const int varId, bool* outVarInitialization)
{
	assert(comp);
